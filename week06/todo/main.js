var TodoBox = React.createClass({
    ...
    _render: function() {
        return ( < div className = "well" >
            <
            h1 className = "vert-offset-top-0" > To do : < /h1> <TodoList data={this.state.data}
            removeNode = { this.handleNodeRemoval }
            toggleComplete = { this.handleToggleComplete }
            />
            TodoForm onTaskSubmit = { this.handleSubmit } < /div>
        );
    },
    get render() {
        return this._render;
                            ...
                            var TodoItem = React.createClass({
                                    ...
                                    render: function() {
                                        ...
                                        if (this.props.complete === 'true') {
                                            ...
                                            return ( < li className = { classes } > { this.props.task } < div className = "pull-right"
                                                role = "group" >
                                                <
                                                button type = "button"
                                                className = "btn btn-xs btn-success img-circle"
                                                onClick = { this.toggleComplete } > & #x2713; < /button> <button type="button" className="btn btn-xs btn-danger img-circle" onClick={this.removeNode}>&#xff38;</button >
                                                <
                                                /div> </li >
                                            ); { "}" } { "}" });
                                        ...
                                        var TodoForm = React.createClass({
                                                ...
                                                function(e) {
                                                    ...
                                                    if (!task) {
                                                        ...
                                                        rbrace;
                                                        render: function() {
                                                            return ( < div className = "commentForm vert-offset-top-2" >
                                                                <
                                                                hr / >
                                                                <
                                                                ...
                                                                <
                                                                label htmlFor = "task"
                                                                className = "col-md-2 control-label" > Task < /label> <div className = "col-md-10" > <
                                                                input type = "text"
                                                                id = "task"
                                                                ref = "task"
